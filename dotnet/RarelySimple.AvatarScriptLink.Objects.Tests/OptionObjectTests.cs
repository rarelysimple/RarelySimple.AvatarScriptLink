...
namespace RarelySimple.AvatarScriptLink.Objects.Tests
{
    ...
    public class OptionObjectTests
    {
        ...
        [TestMethod]
        public void TestOptionObject_HasForms_WhenEmpty()
        {
        ...
        [TestMethod]
        public void TestOptionObject_HasForms_WhenNotEmpty()
        {
            var optionObject = OptionObject.Initialize();
        ...
        [TestMethod]
        public void TestOptionObject_HasForms_WhenMultipleForms()
        {
            var optionObject = OptionObject.Initialize();
            optionObject.Forms.Add(FormObject.Initialize());
            optionObject.Forms.Add(FormObject.Initialize());
