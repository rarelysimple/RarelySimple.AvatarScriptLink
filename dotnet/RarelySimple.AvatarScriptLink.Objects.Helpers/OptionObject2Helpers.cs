...
namespace RarelySimple.AvatarScriptLink.Objects.Helpers
{
    ...
    public static class OptionObject2Helpers
    {
        ...
        /// <summary>
        /// Gets a <see cref="FormObject"/> in an <see cref="OptionObject2"/> by form ID.
        /// </summary>
        /// <param name="optionObject">The OptionObject2 to query.</param>
        /// <param name="formId">The form ID to search for.</param>
        /// <returns>The matching form object, or null if not found.</returns>
        public static FormObject? GetFormObject(this OptionObject2 optionObject, string formId)
        {
        ...
        /// <exception cref="ArgumentNullException">Thrown when <paramref name="optionObject"/> is null.</exception>
        /// <exception cref="ArgumentException">Thrown when <paramref name="optionObject"/>.<see cref="OptionObject2.Forms"/> is null, when <paramref name="rowId"/> is null/empty, or when no matching row is found.</exception>
        /// <returns>The modified option object.</returns>
