...
namespace RarelySimple.AvatarScriptLink.Net.Decorators
{
    public sealed partial class OptionObject2Decorator
    {
        private sealed class Helper : DecoratorHelper
        {
            ...
            /// <summary>
            /// Disables all <see cref="FieldObject"/> in the <see cref="OptionObject2Decorator"/>.
            /// </summary>
            /// <param name="optionObject"></param>
            /// <returns></returns>
            public static OptionObject2Decorator DisableAllFieldObjects(OptionObject2Decorator optionObject)
            {
                if (optionObject == null)
                    throw new ArgumentNullException(nameof(optionObject), resourceManager.GetString(ParameterCannotBeNull, CultureInfo.CurrentCulture));
            ...
            /// <summary>
            /// Disables all <see cref="FieldObject"/> in the <see cref="OptionObject2Decorator"/>, except for the FieldNumbers specified in the list.
            /// </summary>
            /// <param name="optionObject"></param>
            /// <param name="excludedFields"></param>
            /// <returns></returns>
            public static OptionObject2Decorator DisableAllFieldObjects(OptionObject2Decorator optionObject, List<string> excludedFields)
            {
                if (optionObject == null)
                    throw new ArgumentNullException(nameof(optionObject), resourceManager.GetString(ParameterCannotBeNull, CultureInfo.CurrentCulture));
                if (optionObject.Forms == null)
