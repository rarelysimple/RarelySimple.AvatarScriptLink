...
namespace RarelySimple.AvatarScriptLink.Net.Decorators
{
    public sealed partial class OptionObjectDecorator
    {
        private sealed class Helper : DecoratorHelper
        {
            ...
            /// <summary>
            /// Returns a list of FieldValues of a specified <see cref="FieldObject"/> in the <see cref="OptionObject"/> by FieldNumber.
            /// </summary>
            /// <param name="optionObject"></param>
            /// <param name="fieldNumber"></param>
            /// <returns></returns>
            public static List<string> GetFieldValues(OptionObjectDecorator optionObject, string fieldNumber)
            {
                if (string.IsNullOrEmpty(fieldNumber))
                    throw new ArgumentNullException(nameof(fieldNumber), resourceManager.GetString(ParameterCannotBeNull, CultureInfo.CurrentCulture));
            ...
            /// <summary>
            /// Executes an operation on a form within the OptionObjectDecorator by FormId.
            /// </summary>
            /// <param name="optionObject"></param>
            /// <param name="formId"></param>
            /// <param name="action"></param>
            /// <returns></returns>
            private static OptionObjectDecorator ExecuteOnForm(OptionObjectDecorator optionObject, string formId, Action<FormObjectDecorator> action)
            {
                if (optionObject == null)
                    throw new ArgumentNullException(nameof(optionObject), resourceManager.GetString(ParameterCannotBeNull, CultureInfo.CurrentCulture));
                if (optionObject.Forms == null)
            ...
            /// <summary>
            /// Adds a <see cref="RowObject"/> to a specified <see cref="FormObjectDecorator"/> within provided <see cref="OptionObjectDecorator"/>.
            /// </summary>
            /// <param name="optionObject"></param>
            /// <param name="formId"></param>
            /// <param name="rowObject"></param>
            /// <returns></returns>
            public static OptionObjectDecorator AddRowObject(OptionObjectDecorator optionObject, string formId, RowObject rowObject)
            {
                if (optionObject == null)
                    throw new ArgumentNullException(nameof(optionObject), resourceManager.GetString(ParameterCannotBeNull, CultureInfo.CurrentCulture));
                if (rowObject == null)
            ...
            /// <param name="optionObject"></param>
            /// <returns></returns>
            public static OptionObjectDecorator DisableAllFieldObjects(OptionObjectDecorator optionObject)
            {
                if (optionObject == null)
                    throw new ArgumentNullException(nameof(optionObject), resourceManager.GetString(ParameterCannotBeNull, CultureInfo.CurrentCulture));
            ...
            /// <returns></returns>
            public static OptionObjectDecorator DisableAllFieldObjects(OptionObjectDecorator optionObject, List<string> excludedFields)
            {
                if (optionObject == null)
                    throw new ArgumentNullException(nameof(optionObject), resourceManager.GetString(ParameterCannotBeNull, CultureInfo.CurrentCulture));
                if (optionObject.Forms == null)
