...
public class OptionObject2015DecoratorTests
{
    ...
    [TestMethod]
    public void TestOptionObject2015Decorator_GetFieldValues_Succeeds()
    {
        var fieldNumber = "123.45";
        var expected = "initial value";
        var fieldObject = new FieldObject()
    ...
    [TestMethod]
    public void TestOptionObject2015Decorator_GetFieldValues_MultipleRows_Succeeds()
    {
        var fieldNumber = "123.45";
        var expected = "initial value";
    ...
    [TestMethod]
    public void TestOptionObject2015Decorator_GetFieldValues_NotPresent()
    {
        var fieldNumber = "123.45";
        var expected = "initial value";
        var fieldObject = new FieldObject()
    ...
    [TestMethod]
    public void TestOptionObject2015Decorator_GetFieldValues_Empty()
    {
        var fieldNumber = "123.45";
        var expected = "initial value";
        var fieldObject = new FieldObject()
    ...
    [TestMethod]
    public void TestOptionObject2015Decorator_GetFieldValues_Null()
    {
        var fieldNumber = "123.45";
        var expected = "initial value";
        var fieldObject = new FieldObject()
    ...
    [TestMethod]
    public void TestOptionObject2015Decorator_AddRowObject_Success()
    {
        var formObject = new FormObject()
        {
            FormId = "1",
    ...
    [TestMethod]
    public void TestOptionObject2015Decorator_AddRowObject_FormNotFound()
    {
        var formObject = new FormObject()
        {
            FormId = "1",
    ...
    [TestMethod]
    public void TestOptionObject2015Decorator_AddRowObject_NullRowObject()
    {
        var formObject = new FormObject()
        {
            FormId = "1",
    ...
    [TestMethod]
    public void TestOptionObject2015Decorator_AddRowObject_WithMultipleRows()
    {
        var formObject = new FormObject()
        {
            FormId = "1",
    ...
    [TestMethod]
    public void DisableAllFieldObjects_PreservesSessionToken()
    {
        var fieldObject = new FieldObject()
        {
            Enabled = "1",
        ...
        var decorator = new OptionObject2015Decorator(optionObject);
        decorator.DisableAllFieldObjects();
        Assert.AreEqual("SESSIONTOKEN123", decorator.SessionToken);
    }
