...
public class OptionObjectDecoratorTests
{
    ...
    [TestMethod]
    public void TestOptionObjectDecorator_Constructor_NullOptionObject()
    {
        Assert.ThrowsException<ArgumentNullException>(() => new OptionObjectDecorator(null));
    }
    ...
    [TestMethod]
    public void TestOptionObjectDecorator_DeleteRowObject_OtherRow()
    {
    ...
    public void DisableAllFieldObjects_PreservesEntityID()
    {
        ...
        var decorator = new OptionObjectDecorator(optionObject);
        decorator.DisableAllFieldObjects();
        Assert.AreEqual("123456", decorator.EntityID);
    }

    [TestMethod]
    public void DisableAllFieldObjects_PreservesOptionId()
    {
        var fieldObject = new FieldObject()
        {
            Enabled = "1",
        ...
        var decorator = new OptionObjectDecorator(optionObject);
        decorator.DisableAllFieldObjects();
        Assert.AreEqual("TEST123", decorator.OptionId);
    }
