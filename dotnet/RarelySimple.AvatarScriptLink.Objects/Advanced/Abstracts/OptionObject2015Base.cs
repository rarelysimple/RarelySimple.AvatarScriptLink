...
{
    public class OptionObject2015Base : ObjectBase, IEquatable<OptionObject2015Base>, IOptionObject2015
    {
        /// <summary>
        ...
        public bool Equals(OptionObject2015Base other)
        {
            if (other == null)
                return false;
        ...
        {
            OptionObject2015Base optionObject = obj as OptionObject2015Base;
        ...
        /// <summary>
        /// Overrides the <see cref="GetHashCode"/> method for a <see cref="OptionObject2015Base"/>.
        /// </summary>
        /// <returns>Returns an <see cref="int"/> representing the unique hash code for the <see cref="OptionObject2015Base"/>.</returns>
        ...
        public static bool operator ==(OptionObject2015Base optionObject1, OptionObject2015Base optionObject2)
        {
