...
namespace RarelySimple.AvatarScriptLink.Objects.Abstracts
{
    public class RowObjectBase : ObjectBase, IRowObject
    {
        ...
        /// <summary>
        /// Gets a value indicating whether the Fields collection contains any elements.
        /// </summary>
        /// <returns>True if Fields is not null and contains at least one field, false otherwise.</returns>
        /// <remarks>
        /// <para>This method safely checks if there are any fields in the row.</para>
        /// <para>Use this method before iterating over Fields to avoid null reference exceptions.</para>
        /// </remarks>
