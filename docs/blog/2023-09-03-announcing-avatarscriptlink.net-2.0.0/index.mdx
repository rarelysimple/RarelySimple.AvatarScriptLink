...
In version 2 it will be implemented like this.
...
While the existing `ToReturnOptionObject()` methods are still available as methods on the decorators, we now have a new return builder you can use to prepare your return object.
