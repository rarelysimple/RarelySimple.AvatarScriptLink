...
An earlier version of this object is still supported and available for use in your projects.
...
| DeleteRowObject([RowObject](./rowobject))     | Marks a [RowObject"](./rowboject) for deletion.            |
| DeleteRowObject(string)                       | Marks a [RowObject"](./rowboject) for deletion by specified RowId.            |
...
| GetFieldValue(string, string, string)         | Returns the value of the [FieldObject"](./fieldboject) matching the Field Number on the specified [FormObject](./formobject) and [RowObject](./rowobject).            |
