---
title: OptionObject2015 Decorator
image: ./OptionObject2015.png
sidebar_position: 1
sidebar_label: OptionObject2015
---
...
The OptionObject2015Decorator adds several utility methods to assist with handlings these objects.

```mermaid
classDiagram
direction LR
class OptionObject2015Decorator {
    +string EntityID
...
OptionObject2015Decorator "1" --o "*" FormObjectDecorator : Forms

click FormObjectDecorator href "./formobject" "Learn more about the FormObjectDecorator"
```
